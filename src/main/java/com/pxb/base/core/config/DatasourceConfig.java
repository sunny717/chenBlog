 ...
 * 
 */
package com.pxb.base.core.config;
 ...
 * @Description: 数据源配置，由于数据库连接池用的是druid，所以需要自己写下代码（如果是支持的tomcat,dbcp这些就不需要重新配置）
 * @author panxiaobo
 * @date 2017年11月28日 下午3:30:28
 * 
 */
@Configuration
